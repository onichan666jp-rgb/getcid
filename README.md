...
<img src="https://getcid.dev/wp-content/uploads/2026/04/getcid-logo.png" alt="GetCID.Dev" width="120"/>
...
**Web:**
1. Go to [getcid.dev](https://getcid.dev)
...
**Telegram Bot:**
1. Open [@gedcidjp_bot](https://t.me/gedcidjp_bot)
2. Send a screenshot of your Activation Wizard or type your IID
3. Receive your CID in seconds
...
|---|---|---|
| Free | $0 | 2/day |
| Bronze | $0.04/CID | Unlimited |
| Silver | $0.03/CID | Unlimited (recharge $100+) |
| Gold | $0.02/CID | Unlimited (recharge $200+) |
...
- Compatible con Windows 10, Windows 11, Office 2021, Office 2024 y más
- Disponible 24/7 por web y bot de Telegram

### Plan Gratuito

> **2 CIDs gratis por día** — sin tarjeta de crédito.

El límite gratuito se reinicia cada 24 horas y funciona tanto en la web como en el bot de Telegram.

### Cómo Usar

**Web:**
1. Ve a [getcid.dev](https://getcid.dev)
...
**Bot de Telegram:**
1. Abre [@gedcidjp_bot](https://t.me/gedcidjp_bot)
2. Envía un screenshot del Asistente de Activación o escribe tu IID
3. Recibe tu CID en segundos

### Precios

| Plan | Precio | CIDs/día |
|---|---|---|
| Free | $0 | 2/día |
| Bronze | $0.04/CID | Ilimitado |
| Silver | $0.03/CID | Ilimitado (recarga $100+) |
| Gold | $0.02/CID | Ilimitado (recarga $200+) |
